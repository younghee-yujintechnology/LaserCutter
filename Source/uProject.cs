  ...
  //      [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
    ...
    public class Model4
    {
        ...
        public StringList ToStringList()
        {
            ...
            Result.Add(String.Format("        Thickness = {0:F3}", Thickness));
            Result.Add(String.Format("        ZOffset = {0:F3}", ZOffset));
            Result.Add(String.Format("        GuideLength = {0:F3}", GuideLength));
            Result.Add(String.Format("        GuidePitch = {0:F3}", GuidePitch));
            Result.Add(String.Format("        XLength = {0:F3}", XLength));
            Result.Add(String.Format("        XPitch = {0:F3}", XPitch));
            Result.Add(String.Format("        YLength = {0:F3}", YLength));
            Result.Add(String.Format("        YPitch = {0:F3}", YPitch));
            Result.Add("    }");
