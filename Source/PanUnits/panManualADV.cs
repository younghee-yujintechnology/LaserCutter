...
namespace LaserCutter
{
    public partial class panManualADV : UserControl
    {
        ...
        public panManualADV()
        {
            ...
            cbComPort.Items.Add(yjTech.Port.COM01.ToString());
            cbComPort.Items.Add(yjTech.Port.COM02.ToString());
            cbComPort.Items.Add(yjTech.Port.COM03.ToString());
            cbComPort.Items.Add(yjTech.Port.COM04.ToString());
            cbComPort.Items.Add(yjTech.Port.COM05.ToString());
            cbComPort.Items.Add(yjTech.Port.COM06.ToString());
            cbComPort.Items.Add(yjTech.Port.COM07.ToString());
            cbComPort.Items.Add(yjTech.Port.COM08.ToString());
            cbComPort.Items.Add(yjTech.Port.COM09.ToString());
            cbComPort.Items.Add(yjTech.Port.COM10.ToString());
            cbComPort.Items.Add(yjTech.Port.COM11.ToString());
            cbComPort.Items.Add(yjTech.Port.COM12.ToString());
            cbComPort.Items.Add(yjTech.Port.COM13.ToString());
            cbComPort.Items.Add(yjTech.Port.COM14.ToString());
            cbComPort.Items.Add(yjTech.Port.COM15.ToString());
        ...
        {
#if _ADV
            Comm.Port = (yjTech.Port)cbComPort.SelectedIndex;
