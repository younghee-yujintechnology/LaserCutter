...
namespace LaserCutter
{
    partial class panJobFile
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnCopyModel = new YujinTechnology.BitBtn();
            this.label1 = new YujinTechnology.Label();
            this.LabelGroup = new YujinTechnology.Label();
            this.btnDeleteModel = new YujinTechnology.BitBtn();
            this.btnRenameModel = new YujinTechnology.BitBtn();
            this.btnAddModel = new YujinTechnology.BitBtn();
            this.btnDeleteGroup = new YujinTechnology.BitBtn();
            this.btnRenameGroup = new YujinTechnology.BitBtn();
            this.btnAddGroup = new YujinTechnology.BitBtn();
        ...
        private YujinTechnology.BitBtn btnDeleteModel;
        private YujinTechnology.BitBtn btnRenameModel;
        private YujinTechnology.BitBtn btnAddModel;
        private YujinTechnology.BitBtn btnDeleteGroup;
        private YujinTechnology.BitBtn btnRenameGroup;
        private YujinTechnology.BitBtn btnAddGroup;
        ...
        private YujinTechnology.Label LabelGroup;
        private YujinTechnology.BitBtn btnCopyModel;
