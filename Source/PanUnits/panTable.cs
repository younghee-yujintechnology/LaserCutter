...
namespace LaserCutter
{
    public partial class panTable: UserControl
    {
        ...
        public void DisplayJobFile()
        {
            ...
            Type4.edGuideLength.Value = LaserProject.Model4.GuideLength;
            Type4.edGuidePitch.Value = LaserProject.Model4.GuidePitch;
            Type4.edXLength.Value = LaserProject.Model4.XLength;
            Type4.edXPitch.Value = LaserProject.Model4.XPitch;
            Type4.edYLength.Value = LaserProject.Model4.YLength;
            Type4.edYPitch.Value = LaserProject.Model4.YPitch;
