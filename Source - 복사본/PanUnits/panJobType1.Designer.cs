...
namespace LaserCutter
{
    partial class panJobType1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.LabelGlassSizeY = new YujinTechnology.Label();
            this.LabelPitch = new YujinTechnology.Label();
            this.LabelManualShiftY = new YujinTechnology.Label();
            this.LabelGlassSizeX = new YujinTechnology.Label();
            this.LabelPower = new YujinTechnology.Label();
            this.LabelManualShiftX = new YujinTechnology.Label();
        ...
        private YujinTechnology.Label LabelGlassSizeY;
        private YujinTechnology.Label LabelPitch;
        private YujinTechnology.Label LabelManualShiftY;
        private YujinTechnology.Label LabelGlassSizeX;
        private YujinTechnology.Label LabelPower;
        private YujinTechnology.Label LabelManualShiftX;
